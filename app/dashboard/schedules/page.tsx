          ...
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="flex items-center gap-2 rounded-full bg-zinc-900 text-[13px] lg:text-[15px] font-normal text-white whitespace-nowrap"
                >
                  <CalendarIcon className="h-4 w-4 lg:h-5 lg:w-5" />
                  <span>{format(date, "EEE dd, MMMM")}</span>
                </Button>
              </PopoverTrigger>
              <PopoverContent className="w-auto p-0 rounded-[2rem] bg-[#181818] backdrop-blur-sm">
                <Calendar
                  mode="single"
                  selected={date}
