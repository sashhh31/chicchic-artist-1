      ...
      <main className="flex-1 overflow-auto">
        <div className="p-6">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden">
            <div className="grid grid-cols-4 p-4 border-b border-gray-700 text-gray-400 text-sm">
              <div>Client</div>
              <div>Service</div>
              <div>Status</div>
              <div>Cost</div>
            ...
            <div className="divide-y divide-gray-700">
              {appointments.map((appointment) => (
                <div
                  key={appointment.id}
                  className="grid grid-cols-4 p-4 hover:bg-gray-700 cursor-pointer transition-colors"
